...
public class ShooterFeederCommandReverse extends Command{
    ...
    public ShooterFeederCommandReverse( FeederSubystem feederSubystem, LeftShooter LeftShooterSubsystem, RightShooter RightShooterSubsystem, double targetShooterRPS ){
