...
//      * targets IDs on the hub 
//      *
//      * @param novacane Name/identifier of the Limelight
//      * @param validLimelightIDs Array of valid AprilTag IDs to track found in constants
//      */
//     public static void SetFiducialIDFiltersOverride(String novacane, int [] validLimelightIDs) {
//         double[] validIDsDouble = new double[validLimelightIDs.length];
//         for (int i = 0; i < validLimelightIDs.length; i++) {
//             validIDsDouble[i] = validLimelightIDs[i];
//         }        
//         setLimelightNTDoubleArray("novocane", "fiducial_id_filters_set", validIDsDouble);
//     }
...
//      * @param mode IMU mode.
//      */
//     public static void SetIMUMode(String novocane, int mode) {
//         setLimelightNTDouble(novocane, "imumode_set", mode);
//     }
